...
//    }
//
//    ofstream ficheroTiempo("registro.ods"); // archivo que guarda registro de tiempo
...
//    auto diff = end - start;
//    ficheroTiempo << G.vertexCount()<<";" <<cant_aristas<<" ;" << chrono::duration <double, milli> (diff).count()<<";" << " ms"<<endl;
//    ficheroSalida.close();
//    ficheroTiempo.close();
//    return 0;
//}
