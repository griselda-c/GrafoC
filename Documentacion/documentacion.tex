...
\begin{figure}
  \centering
   \includegraphics[width=0.8\textwidth]{./real_arista.jpeg}
...
\begin{figure}
  \centering
   \includegraphics[width=0.8\textwidth]{./erdos_aristas.jpeg}
...
\begin{figure}
  \centering
   \includegraphics[width=0.8\textwidth]{./gnp_aristas.jpeg}
...
\begin{figure}
  \centering
   \includegraphics[width=0.8\textwidth]{./newman_arista.jpeg}
...
\begin{figure}
  \centering
   \includegraphics[width=0.8\textwidth]{./dense.jpeg}
  \fbox{Gráfico del tiempo de ejecución de $100$ dense\_gnm\_random\_graph}
...
\bibliography{../../../../biblio/biblio-new}
